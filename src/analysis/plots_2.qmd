...
env_contribs <- ggplot(df_long_1, aes(as.factor(Vote), Contribution_plus)) +
    ...
    labs(
        ...
        y = "Amount of contribution in 100 USD"
    )
env_contribs
...
ggsave("env_contribs.svg", plot = env_contribs, width = 6, height = 6, units = "in", dpi = 300)
ggsave("anti_env_contribs.svg", plot = anti_env_contribs, width = 6, height = 6, units = "in", dpi = 300)
...
pro_plot_contribs <- df_long %>%
    ...
    labs(
        ...
        x = "Amount of contribution in 100 USD",
        y = "Frequency"
    ) +
...
ggsave("pro_plot_contribs.svg", plot = pro_plot_contribs, width = 6, height = 6, units = "in", dpi = 300)
ggsave("anti_plot_contribs.svg", plot = anti_plot_contribs, width = 6, height = 6, units = "in", dpi = 300)
```
