...
```{r}
# try it with sessionized, incl. all data leading up to the vote, not just vote
# start with Vote, Vote3 first vote
view(df_vote_4_2)
ols_4_2 <- lm(Vote4_plus ~ . - Vote4_minus - Vote4 - Vote_change_dummy - Vote4_NA, data = df_vote_4_2)
# doesnt work yet, go to prep_analysis to rename and remove Vote dummy cols
summary(ols_4_2)
```
