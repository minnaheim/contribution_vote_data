...
df_vote_change_wide <- read.csv("/Users/minna/Desktop/HSG/Economics/BA_Thesis/code/data/analysis/df_vote_change_wide.csv")
...
df_vote_change_wide <- df_vote_change_wide %>% select(-c(GovtrackID, opensecrets_id, Vote_change_dummy, Vote_change, first_name, last_name, name, Vote_count, Vote_change, vote_change_year, seniority_113, seniority_114, seniority_115, seniority_116, seniority_117, first_vote, first_contribution_minus, first_contribution_plus, Vote3, Vote4, Vote51, Vote52, Vote6, Vote7, district, state))
kable(df_vote_change_wide[1:10, ], format = "html")
```
...
# same with the wide format one:

# ols_change_wide <- lm(vote_change_to_pro ~ . - vote_change_to_anti - BioID, data = df_vote_change_wide)
# summary(ols_change_wide)
```
