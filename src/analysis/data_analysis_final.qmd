...
# same thing with plm
ols_party_plm <- plm(Vote ~ district + birthday + nominate_dim1 + nominate_dim2 + Geographical + party + Instance + seniority + gender + pro_env_dummy + anti_env_dummy,
...
# Vote 4_2
view(df_vote_4_2)
ols_4_2 <- plm(Vote4_minus ~ Contribution_3_minus + Contribution_3_plus + Contribution_4_minus + Contribution_4_plus + seniority_114 + nominate_dim1 + nominate_dim2 + gender + pro_env_dummy + anti_env_dummy, data = df_vote_4_2, index = c("state", "party"), model = "within", effect = "twoways")
summary(ols_4_2)

# Vote 51_2
ols_51_2 <- plm(Vote51_minus ~ Contribution_3_minus + Contribution_3_plus + Contribution_4_minus + Contribution_4_plus + Contribution_51_minus + Contribution_51_plus + seniority_1151 + party + nominate_dim1 + nominate_dim2 + gender + pro_env_dummy + anti_env_dummy, data = df_vote_51_2, index = c("state"), model = "within", effect = "twoways")
summary(ols_51_2)
...
# Vote 7_2
view(df_vote_7_2)
ols_7_2 <- plm(Vote7_minus ~ Contribution_3_minus + Contribution_3_plus + Contribution_4_minus + Contribution_4_plus + Contribution_51_minus + Contribution_51_plus + Contribution_52_minus + Contribution_52_plus + Contribution_6_minus + Contribution_6_plus + Contribution_7_minus + Contribution_7_plus + seniority_117 + party + gender + pro_env_dummy + anti_env_dummy + nominate_dim1 + nominate_dim2, data = df_vote_7_2, index = c("state"), model = "within", effect = "twoways")
summary(ols_7_2)
```
...
```{r}
ols_party_change <- lm(Vote ~ birthday + nominate_dim1 + nominate_dim2 + Geographical + as.factor(party) + as.factor(Instance) + seniority + Contribution_minus + Contribution_plus + gender + pro_env_dummy + anti_env_dummy, data = df_long)
...
main_ols <- stargazer(lpm1, lpm2, lpm3, lpm4, lpm5,
    covariate.labels = c("District", "PartyR", "Birthyear", "GenderM", "1st dimension DW Nominate", "2nd dimension DW Nominate", "GeographicalNE", "GeographicalSO", "GeographicalWE", "Vote Number", "Seniority", "Anti-Env Contributions Amount", "Pro-Env Contributions Amount", "Democratic Majority in House", "Anti-Env Contribution Dummy", "Pro-Env Contribution Dummy", "Constant"),
...
# covariate.labels = c("District" ,"PartyR", "Birthyear", "GenderM", "1st dimension DW Nominate", "2nd dimension DW Nominate", "GeographicalNE","GeographicalSO", "GeographicalWE", "Vote Number", "Seniority", "Pro Env Contributions Amount", "Anti Env Contributions Amount", "Democratic Majority in House", "Pro-Env Contribution Dummy", "Anti-Env Contribution Dummy", "Constant")
...
# summary statistics
stargazer(df_long,
    type = "html", title = "Descriptive statistics", out = "summary_stats.html", covariate.labels = c("District", "Vote Change", "Birthyear", "1st dimension DW Nominate", "2nd dimension DW Nominate", "Vote Number", "Seniority", "Pro Env Contributions Amount", "Anti Env Contributions Amount", "Democratic Majority in House", "Pro-Env Contribution Dummy", "Anti-Env Contribution Dummy"),
    order = c("Anti-Env Contributions Amount", "Pro-Env Contributions Amount")
)
