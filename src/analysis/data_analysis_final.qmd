...
ols_party_dummy <- plm(Vote ~ district + birthday + nominate_dim1 + nominate_dim2 + Geographical + party + Instance + seniority + gender + Contribution_minus + Contribution_plus + pro_env_dummy + anti_env_dummy, index = c("party", "Instance"), model = "within", data = df_long)
summary(ols_party_dummy)

# same thing with plm
ols_party_plm <- plm(Vote ~ district + birthday + nominate_dim1 + nominate_dim2 + Geographical + party + Instance + seniority + gender + pro_env_dummy + anti_env_dummy, index = c("Instance", "party"), data = df_long)
...
# same thing with plm
ols_geo_plm <- plm(Vote ~ district + party + birthday + nominate_dim1 + nominate_dim2 + seniority + Contribution_minus + Contribution_plus + gender + pro_env_dummy + anti_env_dummy, index = c("Geographical", "Instance"), model = "within", data = df_long)
summary(ols_geo_plm)
...
ols_geo_log_plm <- plm(Vote ~ district + party + birthday + nominate_dim1 + nominate_dim2 + seniority + Contribution_minus_log + Contribution_plus_log + gender + pro_env_dummy + anti_env_dummy, index = c("Geographical", "Instance"), model = "within", data = df_long_log)
...
# same thing again with plm
ols_ind_fe_plm <- plm(Vote ~ nominate_dim1 + nominate_dim2 + seniority + Contribution_minus + Contribution_plus, data = df_long, index = c("BioID", "Instance"), model = "within")
summary(ols_ind_fe_plm)

# same thing again with log
ols_ind_fe_log <- lm(Vote ~ district + party + birthday + nominate_dim1 + nominate_dim2 + as.factor(Instance) + as.factor(BioID) + seniority + Contribution_minus_log + Contribution_plus_log, data = df_long_log)
summary(ols_ind_fe_log)

# same thing with only dummies
ols_ind_fe_dummy <- lm(Vote ~ nominate_dim1 + nominate_dim2 + as.factor(Instance) + as.factor(BioID) + seniority + anti_env_dummy + pro_env_dummy, data = df_long)
...
ols_change_fe_2 <- lm(vote_change_to_anti ~ as.factor(Geographical) + as.factor(Instance) + party + birthday + district + nominate_dim1 + nominate_dim2 + seniority + Contribution_minus + Contribution_plus + gender + pro_env_dummy, data = df_vote_change)
...
# same thing with vote_change_to_anti
ols_party_change_2 <- lm(vote_change_to_anti ~ district + birthday + nominate_dim1 + nominate_dim2 + Geographical + as.factor(party) + as.factor(Instance) + seniority + Contribution_minus + Contribution_plus + gender + pro_env_dummy, data = df_vote_change)
summary(ols_party_change_2)
```

## with state & year FEs
```{r}
ols_change_state <- lm(Vote ~ as.factor(state) + as.factor(Instance) + birthday + district + nominate_dim1 + nominate_dim2 + seniority + Contribution_minus + Contribution_plus + gender + pro_env_dummy, data = df_vote_change)
summary(ols_change_state)

# same thing with vote_change_to_anti
ols_change_state_2 <- lm(vote_change_to_anti ~ as.factor(state) + as.factor(Instance) + birthday + district + nominate_dim1 + nominate_dim2 + seniority + Contribution_minus + Contribution_plus + gender + pro_env_dummy, data = df_vote_change)
...
log2 <- full_logit_log
log3 <- full_logit_geo
log4 <- full_logit_state
log5 <- logit_ind_fe

# create model summaries
main_ols <- stargazer(lpm1, lpm2, lpm3, lpm4, lpm5, type = "html", out = "LPM_main.html")
basic_ols <- stargazer(lpm6, lpm1, lpm7, type = "html", out = "LPM_basic.html")
party_ols <- stargazer(lpm3, lpm8, type = "html", out = "LPM_party.html")
geo_ols <- stargazer(lpm2, lpm7, lpm8, type = "html", out = "LPM_geo.html")
geo_ols <- stargazer(lpm2, lpm9, type = "html", out = "LPM_geo_log.html")
state_ols <- stargazer(lpm4, lpm9, type = "html", out = "LPM_state.html")
main_logit <- stargazer(log1, log5, lpm1, type = "html", out = "LPM_main_2.html")

# summary statistics
stargazer(df_long, type = "html", title = "Descriptive statistics", out = "summary_stats.html")

# state_ols <- stargazer(ols_state_fe, ols_state_fe_log, ols_state_fe_dummy, type = "text")
# ind_ols <- stargazer(ols_ind_fe, ols_ind_fe_log, ols_ind_fe_dummy, type = "text")
# ols_per_vote <- stargazer(ols_4_2, ols_51_2, ols_52_2, ols_6_2, ols_7_2, type = "text")
# consistent_ols <- stargazer(ols_no_change, ols_party_no_change, ols_no_change_state_fe, ols_no_change_ind_fe, type = "text")
