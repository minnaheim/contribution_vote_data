...
```{r, include=FALSE}
df <- read.csv("/Users/minna/Desktop/HSG/Economics/BA_Thesis/code/data/cleaned/analysis/df.csv")
df_sum <- read.csv("/Users/minna/Desktop/HSG/Economics/BA_Thesis/code/data/cleaned/analysis/df_sum.csv")
df_subsample <- read.csv("/Users/minna/Desktop/HSG/Economics/BA_Thesis/code/data/cleaned/analysis/df_subsample.csv")
...
time fixed effects --  This model eliminates omitted variable bias caused by excluding unobserved variables that evolve over time but are constant across entities.
### mind changers 
```{r}
