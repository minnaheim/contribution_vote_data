...
indivs20 <- read_delim("data/original/contributions/CampaignFin20/indivs20.txt",
    delim = ",",
    col_names = c(
...
# pipe to head, this way we can see the first few rows of the df, using lazyread
# indivs20 %>%
