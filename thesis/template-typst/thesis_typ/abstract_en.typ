#let abstract_en() = {
  ...
  text[Wealthy donors such as the Koch brothers of Koch Industries have contributed over 27 million USD to various congressional candidates in the 2022 election. This paper analyses whether such contributions from anti-environmental interest groups such as Koch Industries influence congressional voting on environmental issues. Building on the work of Stratmann (2002), it examines repeated roll call votes on methane pollution and the corresponding campaign contributions received by US representatives within six months of these votes. Using a causal identification strategy, the analysis attempts to determine the impact of pro- and anti-environmental contributions on voting behaviour and finds that pro-(anti-)environmental contributions have a positive (negative) effect on voting behaviour, although no causal relationship can be definitively established due to the small number of representatives who change their voting behaviour.]
